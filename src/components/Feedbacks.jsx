...
const FeedbackCard = ({index ,testimonial, name, company, designation, image}) =>(
  ...
  className="bg-gradient-to-r from-[#1e0039] via-[#170027] to-[#0f001a] p-10 rounded-3xl xs:w-[320px] w-full">
    <p className="text-white font-black text-[48px]">"</p>

    <div className="mt-1">
    <p className="tracking-winder text-[18px] text-white">{testimonial}</p>
